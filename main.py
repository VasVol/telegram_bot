...
TOKEN: Final = "6078048516:AAFJElCZkGyqXzp0EAUicd9PATxa0WzeuFg"
BOT_USERNAME: Final = "@VolovichBot"
...
async def handle_photo(update, context):
    ...
    await update.message.reply_text(f"In this image I see a {my_AI.class_names[np.argmax(prediction)]}")


# Lets us use the /start command
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello, I'm an AI that can look at photo and say, what I see on them: Plane, Car, Bird, Cat, Deer, Dog, Frog, Horse, Ship or Truck.\n"
                                    "Use /train command to train me.")


async def train_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Please wait a bit, training takes about 1 minute")
